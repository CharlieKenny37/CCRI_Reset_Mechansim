/*  Reset_Mechanism_Ros is the arudino code that controls the Reset Mechanism. The Reset Mechanism performs two main functions, resetting an object that a robot arm
